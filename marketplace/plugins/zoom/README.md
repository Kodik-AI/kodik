...
Invoke developer skills explicitly by mentioning a skill such as `$start` or `$setup-zoom-oauth`.
...
```text
Search my recent Zoom meetings for the discussion about SDK migration.
```
